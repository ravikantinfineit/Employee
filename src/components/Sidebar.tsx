...
const Icons = {
  ...
  Invoice: FaFileInvoiceDollar as React.ComponentType<{
    size?: number;
    className?: string;
  }>,
  Money: FaMoneyBillWave as React.ComponentType<{
    size?: number;
    className?: string;
  }>,
  Employee: FaUserTie as React.ComponentType<{
    size?: number;
    className?: string;
  }>,
  Units: FaCubes as React.ComponentType<{ size?: number; className?: string }>,
  Client: FaAddressBook as React.ComponentType<{
    size?: number;
    className?: string;
  }>,
   Service: FaConciergeBell as React.ComponentType<{ size?: number; className?: string }>,
};
